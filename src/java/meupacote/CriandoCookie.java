...
public class CriandoCookie extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Criando um Cookie</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h2>Seu cookie foi criado com sucesso!</h2><a href=\"VisualizaCookie\">" + "Clique aqui para ver Cookie criado </a>");
            out.println("</body>");
            out.println("</html>");
        }
    }
